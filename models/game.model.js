...
class GameModel extends Model {
	...
	async getSession() {
		...
		try{
			...
			let [get_session_result] = await this.executeQuery(get_session_query);
	...
	async updateSessionStatus() {
		...
		try{
			...
			let update_session_result 	= await this.executeQuery(update_session_query);
	...
	async clearSession() {
		...
		try{
			...
			let clear_session_result 	= await this.executeQuery(clear_session_query);
